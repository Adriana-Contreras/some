 ...
 */
public class FaceDetectionFragmenttt extends Fragment {
    private TextView textNextAwards, textPrevAwards;
    private ViewPager viewPager;
    private View view;

    public FaceDetectionFragmenttt() {
    ...
    public void _initializeInflater(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.fragment_face_detection_fragmenttt, container, false);
    }
